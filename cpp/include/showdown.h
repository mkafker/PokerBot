...
namespace Poker {
    ...
    extern  void sortCards(std::vector<Card> h) {
            // Sorts cards in place
            std::sort(h.begin(), h.end(), [](const Card& a, const Card& b) { return a<b; });
        };
    extern    void sortCardsDescending(std::vector<Card> h) {
            // Sorts cards in place
            std::sort(h.begin(), h.end(), [](const Card& a, const Card& b) { return a>b; });
        };

    extern    const FullHandRank calcFullHandRank(const std::vector<Card>& hand_in) {
    ...
    extern const FullHandRank& showdownFHR(const FullHandRank& A, const FullHandRank& B) {
