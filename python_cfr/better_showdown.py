...
def showdown_poker(player_cards, community_cards):
    ...
    for i in range(len(player_cards)):
        user_hand.update({i: Card(player_cards[i].rank, suit_num_to_str[player_cards[i].suit])})
    for i in range(len(community_cards)):
        user_hand.update({i + len(player_cards): Card(community_cards[i].rank, suit_num_to_str[community_cards[i].suit])})
