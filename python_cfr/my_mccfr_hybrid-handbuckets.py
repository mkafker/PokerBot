...
def chance_util(i_map, start_from, infoset_key, deck, 
    ...
    if len(action_history) == 1 and len(action_history[0]) == 0: # Initializing
        ...
        # for deal in [deck.draw_random_cards(2)]: # Bad MC-CFR, too much MC
            ...
            if start_from == "P1":
                ...
                p1_hs_hist = ""
                infoset_key = f'P1;{p_cards[0]}/{p_cards[1]};;aa/'
                ...
                p2_hs_hist = ""
                infoset_key = f'P2;{p_cards[0]}/{p_cards[1]};;aa/'
                ...
                p1_hs_hist = ""
                p1_infoset_key = f'P1;{s_cards[0]}/{s_cards[1]};;aa/'
    ...
    if len(action_history) > 1:
        ...
        new_infoset_key = infoset_key.split(";")
        # new_infoset_key = [new_infoset_key[0]] + [p1_hs_hist] + [new_infoset_key[-1]]
        new_infoset_key = [new_infoset_key[0]] + [new_infoset_key[1]] + [p1_hs_hist] + [new_infoset_key[-1]]
        new_infoset_key = ';'.join(new_infoset_key) + "/"
